...
* 判定は設定したワードの部分一致で音声案内を行います。 例) 検索タイトルに「テスト」と設定すると、通知のタイトルが「**テスト**通知」、「通知**テスト**」の場合に音声案内の対象になります。
...
> 検索タイトルが重複しないように末尾に番号をつけた検索タイトルを設定します。
...
> ⚠️ 更新タイミングによっては、反映前の音声メッセージとなることがあります。その場合は検索タイトルをタップして下さい。  
